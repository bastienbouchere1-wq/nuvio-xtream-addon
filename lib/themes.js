...
// Chaînes les plus connues, dans l'ordre de priorité (les mieux classées remontent en tête).
const POPULAR = [
  'tf1', 'france 2', 'france 3', 'france 5', 'm6', 'arte', 'france 4', 'canal+',
  'c8', 'w9', 'tmc', 'tfx', 'cstar', 'nrj 12', '6ter', 'gulli', 'chérie 25', 'rmc story',
  'bfm tv', 'cnews', 'lci', 'franceinfo', 'france info', 'euronews',
  'bein sports 1', 'bein sports 2', 'bein sports 3', 'bein sports max 1', 'bein sports max 2', 'bein sports max 3',
  'canal+ sport', 'canal+ foot', 'canal+ can', 'rmc sport 1', 'rmc sport 2',
  'eurosport 1', 'eurosport 2', 'dazn 1', 'dazn 2', 'ligue1+', 'l equipe', 'lequipe',
  'canal+ cinema', 'ocs', 'tcm cinema', 'rmc decouverte', 'national geographic', 'ushuaia tv',
  'disney channel', 'gulli', 'tiji', 'boomerang', 'nickelodeon'
];
...
module.exports = { order, labels, classify, rank };
